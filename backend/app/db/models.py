...
class Crew(Base):
    ...
    provider_type: Mapped[str | None] = mapped_column(String(24), nullable=True, index=True)
...
class WorkOrder(Base):
    ...
    execution_mode: Mapped[str] = mapped_column(String(24), default="DEPARTMENTAL")
    department_id: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    contract_id: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    amc_id: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    oem_service_id: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
